                    ...
                    <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                ...
                                @if($category->getNoOfProducts() < 3) @continue; @endif <li class="dropdown yamm mega-menu">
                                        ...
                                        <li>
                                            <div class="yamm-content ">
                                                <div class="row">
                                                    ...
                                                    @if($subCategory->getNoOfProducts() < 3) @continue; @endif <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                                                        <h2 class="title">
                                                        ...
                                                        <ul class="links">
                                                            ...
                                                            @if($miniCategory->getNoOfProducts() < 3) @continue; @endif <li style="padding-left: 7px;"><a href="{{url('shop/category/'.$miniCategory->slug)}}">{{ucwords($miniCategory->name)}}</a>
                                        </li>
                                        @endforeach
