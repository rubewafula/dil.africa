    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                ...
                <li class='active'>Agent Sign Up</li>
            </ul>
...
<div class="col-md-12 col-sm-12 create-new-account">
    ...
    <h4 style="color: #0F7DC2;">Create your account as a DASA (DIL.AFRICA Sales) Agent</h4>
</div>
<!-- create a new account -->
<div class="col-md-8 col-sm-8 col-md-offset-1 create-new-account hidden-xs hidden-sm">

    <form class="address-form" role="form" method="POST" action="{{url('shop/register-agent')}}">
