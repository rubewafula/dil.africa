        ...
        <div class="products">
            ...
            <div class="product">		
                ...
                <div class="product-info text-left">
                        <h3 class="name"><a href="{{url('shop/product/detail/'.$product->product->slug)}}">{{ ucwords($product->product->name) }}</a></h3>
                        ...
                        <div class="product-price"> 
                            ...
                            <span class="price-before-discount">
                                ...
                                @php($sale_price = $standard_price + $product->product->getShippingCost())
                            </span> 
                            @else 
                            <span class="price">
                            Ksh {{ number_format($standard_price) }}
                        ...
                        <div class="product-price"> 
                            ...
                            <span class="price">
                                ...
                                KSh {{$min_price + $product->product->getShippingCost()}} - KSh {{$max_price + $product->product->getShippingCost()}}
                            ...
                            <ul class="list-unstyled">
                                <li class="add-cart-button btn-group">
                                    <form method="POST" action="{{url('shop/add_to_cart')}}">
                                        ...
                                        <button data-toggle="tooltip" class="btn btn-primary icon addtocart" type="submit" product_ref="{{$product_price->first()->id}}" title="Add Cart">
                                ...
                                <li class="lnk wishlist">
                                    <a class="add-to-cart" href="{{url('shop/add_to_wishlist/'.$product->product->id.'/'.$product_price->first()->id)}}" title="Wishlist">
