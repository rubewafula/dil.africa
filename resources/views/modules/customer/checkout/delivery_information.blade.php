            ...
            $('input[name="preferred_shippingmode"]').change(function(){
                ...
                success: function (output) {
                    ...
                    if (output.status == '200') {                   
                        console.log("Delivery method set successfully");
                        console.log(output.delivery_type);
                    }else {}
                }
            });
            });
                                ...
                                <div class="panel-body" style="background: #f5f5f5;padding: 7px 20px">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-sm-12 col-xs-12" style="background: #fff;padding: 10px;margin-bottom: 10px;">
                                            ...
                                            <form class="address-form" role="form" method="POST" action="{{url('shop/checkout/save-address')}}">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12 already-registered-login">
                                                        <div class="form-group">
                                                            ...
                                                            {!! Form::text('recipient', isset($user)?$user->first_name.' '.$user->last_name:null, ['class' => 'form-control unicase-form-control text-input city-select', 
                                                            'id'=>'recipient', 'placeholder'=>'', 'required' => 'required']) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                    ...
                                    <div class="col-md-4 animate-dropdown hidden-sm hidden-xs" style="line-height: 1.8em;">
                                        ...
                                        <div style="background: #fff;padding: 10px;">
                                            ...
                                            <div style="border-bottom: 1px solid #ddd;font-weight: bold;font-size: 14px;padding: 2px;">
                                                YOUR ORDER ({{$no_of_items}} @if($no_of_items == 1) item @else items @endif)
                                            </div>
                                            @php($subtotal = 0)
                                        ...
                                        <div class="col-md-12" style="text-align: center;font-size: 16px;margin-top: 10px;">
                                            <a href="{{url('/shop/cart')}}" style="text-transform: uppercase;color: #ffa200;font-weight: bold;">MODIFY CART</a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body"  style="border: 1px solid #ddd;">
                                                ...
                                                <div class="row" style="background:#ddd;color:#337AB7;padding: 10px 0px;margin: 0px;font-weight: bold;">
                                                    <div class="col-md-3 col-xs-12 col-sm-12">Delivery Address</div>
                                                    <div class="col-md-3 col-xs-12 col-sm-12">Location</div>
                                                    <div class="col-md-2 col-xs-12 col-sm-12">City</div>
                                                    <div class="col-md-2 col-xs-12 col-sm-12">Country</div>
                                                ...
                                                <div class="row" style="background:#fff;padding: 10px 0px;">
                                                    <div class="col-md-3 col-xs-12 col-sm-12">{{$address->delivery_address}}</div>
                                                    <div class="col-md-3 col-xs-12 col-sm-12">{{$address->google_area}}</div>
                                                    <div class="col-md-2 col-xs-12 col-sm-12">{{($address->city != null)?$address->city->name:""}}</div>
                                                    <div class="col-md-2 col-xs-12 col-sm-12">{{($address->country != null)?$address->country->name:""}}</div>
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in">
                        ...
                        <div class="panel-body">
                            <div class="row">	
                                ...
                                <div class="col-md-8 col-sm-12 col-xs-12" style="background: #fff;padding: 10px;margin-bottom: 10px;">	
                                    <form class="address-form" role="form" method="POST" action="{{url('shop/checkout/save-pickup-station')}}">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <div id="stations_table" class="row hidden-xs" style="background:#ddd;color:#337AB7;padding: 10px 0px;font-weight: bold;">
                                            <div class="col-md-4 col-xs-12 col-sm-12 col-padding">Pickup Station</div>
                                            <div class="col-md-4 col-xs-12 col-sm-12 col-padding">City</div>
                                            <div class="col-md-4 col-xs-12 col-sm-12 col-padding"></div>                    
                                        </div>

                                        @foreach($stations as $station)

                                        <div class="row" style="background:#fff;padding: 10px 0px;border-bottom: 1px solid #ddd;">
                                            <div class="col-md-4 col-xs-12 col-sm-12 col-padding">
                                                <span class="hidden-lg hidden-md blue-text"> Pickup Station: </span>{{$station->warehouse->name}}
                                            </div>
                                            <div class="col-md-4 col-xs-12 col-sm-12 col-padding">
                                                <span class="hidden-lg hidden-md blue-text"> City: </span> {{($station->warehouse->city != null)?$station->warehouse->city->name:""}}
                                            </div>
                                            <div class="col-md-4 col-xs-12 col-sm-12 col-padding">
