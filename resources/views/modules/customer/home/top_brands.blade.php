                        ...
                        <div class="product-micro">
                            <div class="col col-xs-6">
                                ...
                                <div class="product-image">
                                    <div class="image">
                                        <a href="{{url('/shop/brand/'.$brand->brand->slug)}}">
                                            <!--                                         <img src="{{url('assets/images/'.$brand->brand->cover_photo)}}" alt=""> -->
                                            <div class="featured-brand">
                                                <span class="helper"></span>
                                                <img  class="brand-featured" src="{{url('assets/images/'.$brand->brand->cover_photo)}}" alt=""/>
                                            </div>
                                        </a>					
                                    </div><!-- /.image -->
                                </div><!-- /.product-image -->
