            ...
            <div class="products">
                ...
                <div class="product">		
                    ...
                    <div class="product-info text-left">
                        <h3 class="name">
                            <a href="{{url('shop/product/detail/'.$product->product->slug)}}">{{$product->product->name}}</a>
                        </h3>
                ...
                <div class="product-image">
                    <div class="image">
                        <a href="{{url('shop/product/detail/'.$product->product->slug)}}">
                            <div class="featured-img">
                                <!-- <span class="helper"></span> -->
                                <img class="img-featured" src="{{url('assets/images/products/'.$product->product->getDefaultImage()->image_url)}}" style="width: 90%;" alt="" />
                            </div>
                        </a>
                    </div><!-- /.image -->          
