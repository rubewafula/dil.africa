<div class="product-slider">
    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
        ...
        @foreach($category->popular_products as $product)
                ...
                <div class="product">		
                    <div class="product-image">
                        <div class="image">
                            <a href="{{url('shop/product/detail/'.$product->product_id)}}">
                                <img  src="{{url('assets/images/products/'.$product->product->getDefaultImage()->image_url)}}" alt=""></a>
                        </div><!-- /.image -->			
                    ...
                    <div class="product-info text-left">
                        ...
                        <div class="product-price">	
                            ...
                            <input type="hidden" value="{{$product->id}}" id="product_phones_ref" />
                        </div><!-- /.product-price -->
