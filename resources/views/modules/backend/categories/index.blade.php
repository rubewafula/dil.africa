...
@section('content')
                ...
                <div id="main-wrapper" class="container">
                    <div class="row">
                        ...
                        <form method="GET" action="{{ url('/backend/categories') }}" accept-charset="UTF-8" class="form-inline " role="search">
  ...
  <div class="form-group mx-sm-12 mb-12">
    ...
    <button class="btn btn-secondary" type="submit">
                                     ...
                                     <div  class="col-md-4 col-sm-12">
                                                     <span  class="pull-right"> <a href="{{ url('/backend/categories/create') }}" class="btn btn-success btn-sm" title="Add New ">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                                    ...
                                    <table id="crud" class="display table" style="width: 100%; cellspacing: 0;">
                                        <thead style="background: #ffa200;color:#fff;opacity: 0.7">
                                            <tr>
                                               <tr>
                                        <th>#</th><th>Name</th><th>Slug</th><th>Cover Photo</th><th>Actions</th>
                                    </tr>
                                            </tr>
                                        </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td><td>{{ $item->slug }}</td><td>{{ $item->cover_photo }}</td>
                                        <td>
