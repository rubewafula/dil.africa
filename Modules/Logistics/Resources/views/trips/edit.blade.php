    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-white">
                ...
                <form method="POST" action="{{ url('/logistics/trips/' . $trip->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ method_field('PATCH') }}
                    {{ csrf_field() }}

                    @include ('logistics::trips.form', ['submitButtonText' => 'Update'])
