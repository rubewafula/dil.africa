...
class QualityPassedNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $mailMessage->greeting('Dear '.$this->user->first_name.',')
            ...
            ->subject('Order Quality Passed')
            ->line('<div style="line-height:1.8em;font-family:Open Sans, sans-serif;">')
            ->line('The quality of your order delivered to <span style="color:#0f7dc2;font-weight:bold;">DIL.AFRICA</span> has been checked and marked as passed. The details of the order you delivered are as below:<br/>')
