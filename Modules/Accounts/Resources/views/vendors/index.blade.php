  ...
  <div class="form-group mx-sm-12 mb-12">
    ...
    <button class="btn btn-secondary" type="submit">
                                     ...
                                     <div  class="col-md-4 col-sm-12">
                                                     <span  class="pull-right"> <a href="{{ url('/accounts/vendors/create') }}" class="btn btn-success btn-sm" title="Add New ">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                                    ...
                                    <table id="crud" class="display table" style="width: 100%; cellspacing: 0;">
                                        <thead style="background: #ffa200;color:#fff;opacity: 0.7">
                                            <tr>
                                               <tr>
                                  <th>Name</th> <th> # Products</th><th>status</th><th>Email  Address</th><th>Actions</th>
                                    </tr>
                                            </tr>
                                        </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                              <a href="{{ url('/backend/sellers/manage/' . $item->id) }}" title="Edit Seller"><button class="btn btn-success btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Manage</button></a>
                                            ...
                                            <form method="POST" action="{{ url('/backend/sellers' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
