...
<div class="form-group">
   ...
   <p>  <a  href="{{url($seller->licence)}}" target="_BLANK"> <img src="{{url($seller->licence)}}" width="130px" /> </a>
           <a href="{{url('accounts/remove_licence/'.$seller->id)}}" onclick="return  confirm('Are  you  sure?')" class="btn btn-danger">  Remove</a>
   </p>
</div>
</div>
...
<div class="form-group">
   ...
   <p> <a  href="{{url($seller->id_front)}}" target="_BLANK"> <img src="{{url($seller->id_front)}}" width="130px" />  </a>
           <a href="{{url('accounts/remove_front_id/'.$seller->id)}}" onclick="return  confirm('Are  you  sure?')" class="btn btn-danger">  Remove</a>
   </p>
</div>
</div>
...
<div class="form-group">
   ...
   <p> <a  href="{{url($seller->id_back)}}" target="_BLANK"> <img src="{{url($seller->id_back)}}" width="130px" />  </a>
           <a href="{{url('accounts/remove_back_id/'.$seller->id)}}" onclick="return  confirm('Are  you  sure?')" class="btn btn-danger">  Remove</a>
   </p>
</div>
</div>
...
<div class="form-group">
   ...
   <p> <img src="{{url($seller->logo)}}" width="130px" /> 
           <a href="{{url('accounts/remove_seller_logo/'.$seller->id)}}" onclick="return  confirm('Are  you  sure?')" class="btn btn-danger">  Remove</a>
   </p>
</div>
</div>
...
<div class="form-group {{ $errors->has('mpesa_no') ? 'has-error' : ''}}">
    {!! Form::label('mpesa_no', 'Mpesa Number', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::text('mpesa_no', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
        {!! $errors->first('mpesa_no', '<p class="help-block">:message</p>') !!}
    </div>
</div>
