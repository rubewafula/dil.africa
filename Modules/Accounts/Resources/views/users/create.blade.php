...
@section('content')
           ...
           <div class="page-breadcrumb" >
                ...
                <div>
                    <div class="container">
                        <h3 style="color: #0F7DC2;font-weight: normal;">  Add a New  User </h3>
                    </div>
                </div>
                <div class="container" >
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel-body">
                            	 ...
                            	 <form method="POST" action="{{ url('/seller/users') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
...
<div class="form-group {{ $errors->has('role_id') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <select name="role_id" class="form-control">
            <?php $roles= App\Role::where('name','seller')->orwhere('name','seller_care')->get(); ?>
...
<div class="form-group">
    <div class="col-md-offset-4 col-md-4">
        <input class="btn btn-primary blue-button" type="submit" value="{{ $submitButtonText or 'Create' }}">
    </div>
</div>
