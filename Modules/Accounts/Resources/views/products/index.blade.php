      ...
      <tr style="border-top: 1px solid #eee;">
          ...
          @endif
           ...
           <td>
          <a href="{{ url('accounts/product/'.$product->slug)}}" target="_BLANK" class="btn-warning btn-sm">Manage</a>

          <a style="margin-right: -14px;" href="{{ url('accounts/delete_product/'.$product->id)}}" class="btn-danger btn-sm" onclick="return confirm('Are you sure  you  want to  delete ?')"> <span class="glyphicon glyphicon-trash" aria-hidden="true"></span> </a>
