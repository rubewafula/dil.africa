...
class SellerController extends Controller
{
    ...
    public  function  vendors()
    {
      ...
      $sellers= Seller::where('account_manager',Auth::user()->id)->OrderBy('id','DESC')->paginate('10');

      return  view('accounts::vendors.index',compact(['sellers','title']));
    ...
    public  function  create_vendor()
    {
       ...
       $title='New  Vendor';
      return  view('accounts::vendors.create',compact(['title']));
    ...
    public function index()
    {
      ...
      if($user->seller_id < 1)
      {
        ...
        Session::flash('flash_message_error','
         ...
         return view('accounts::manage_profile');
      }
      ...
      if($user->hasRole('seller'))
      {
        ...
        return view('accounts::seller_dashboard', compact('orders'));
      } 

    if($user->hasRole('seller_care'))
    {
        return view('accounts::clerk_dashboard');
    }
  ...
  public  function  register_seller()
  {
    ...
    return view('accounts::auth.register_seller');
  }
  ...
  public function my_promotions(){
      ...
      return view('accounts::promotions.index', compact('promotions'));
  }
  ...
  public  function  product_classify()
  {
      ...
      return  view('accounts::product_classify');
  }
  ...
  public  function  start_product(Request  $request)
  {
    ...
    $request->validate(['category'=>'required','seller_id'=>'required']);

    return redirect('accounts/products/new/'.$request->category.'/'.$request->seller_id);
  }
  ...
  public  function  products(Request  $request)
  {
  	 ...
  	 if($request->has('search'))
        ...
        $products= Product::where('seller_id',Auth::user()->seller_id)->OrderBy('id','DESC')->limit(30)->get();
         ...
         return  view('accounts::products.index',compact('products'));
   
  }

  public function  new_product($category_id,$seller_id)
  {

     $title=  'New Product';
     $type = 'New';
     return view('accounts::products.new_product',compact('category_id','title', 'type','seller_id'));
  ...
  public  function  load_brands(Request  $request)
  {
   ...
   public function  generate_product_code($seller_id)
   {
      $seller= Seller::find($seller_id);
       $cat_code= substr($seller->name,0,3);

      //
      $product= Product::where('seller_id',$seller_id)->OrderBy('id','DESC')->first();
  ...
  public  function  save_products(Request  $request)
  {
    ...
    if($request->product_id <  1)
    {
         ...
         if(Product::where('slug',$slug)->exists())
         {
           ...
           $requestData['product_code']=$this->generate_product_code($request->seller_id);
           ...
           return  redirect('accounts/product/'.$product->slug)->withInput(['tab'=>'tab2']);
...
// New  Product
      ...
      // $product->categories()->attach($request->category_id);
       ...
       Session::flash('flash_message','Product details updated successfully');
        return  redirect('accounts/product/'.$product->slug);
  ...
  public  function  manage_product($slug)
  {
    ...
    return  view('accounts::products.manage_product',compact('product','category_id'));
  ...
  public  function  view_orders()
  {
    ...
    return  view('accounts::orders.index',compact('seller'));
  }
  ...
  public function  manage_order($id)
  {
       ...
       return  view('accounts::orders.order_detail',compact('order'));
  }
  ...
  public function  sales_report(Request  $request)
  {
      ...
      return  view('accounts::reports.sales_report',compact('orders'));
  }
  ...
  public function promote_product($id){
    ...
    return view('accounts::products.promote_product', compact('product_price'));
  }
 ...
 // Product_feature::where('product_id',$request->product_id)->update($features);
  ...
  public  function  logout()
  {
    ...
    Session::flash('flash_message','You have  successfully logged  out. Please  welcome  back  soon');
    return  redirect('seller/login');
