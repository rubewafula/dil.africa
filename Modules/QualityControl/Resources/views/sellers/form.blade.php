...
<div class="form-group">
   ...
   <p>  <a  href="{{url($seller->licence)}}" target="_BLANK"> <img src="{{url($seller->licence)}}" width="130px" /> </a>
           <a href="{{url('qc/remove_licence/'.$seller->id)}}" onclick="return  confirm('Are  you  sure?')" class="btn btn-danger">  Remove</a>
   </p>
</div>
</div>
...
<div class="form-group">
   ...
   <p> <a  href="{{url($seller->id_front)}}" target="_BLANK"> <img src="{{url($seller->id_front)}}" width="130px" />  </a>
           <a href="{{url('qc/remove_front_id/'.$seller->id)}}" onclick="return  confirm('Are  you  sure?')" class="btn btn-danger">  Remove</a>
   </p>
</div>
</div>
...
<div class="form-group">
   ...
   <p> <a  href="{{url($seller->id_back)}}" target="_BLANK"> <img src="{{url($seller->id_back)}}" width="130px" />  </a>
           <a href="{{url('qc/remove_back_id/'.$seller->id)}}" onclick="return  confirm('Are  you  sure?')" class="btn btn-danger">  Remove</a>
   </p>
</div>
</div>
...
<div class="form-group">
   ...
   <p> <img src="{{url($seller->logo)}}" width="130px" /> 
           <a href="{{url('qc/remove_seller_logo/'.$seller->id)}}" onclick="return  confirm('Are  you  sure?')" class="btn btn-danger">  Remove</a>
   </p>
</div>
</div>
