  ...
  @section('content')
             ...
             <div class="page-breadcrumb" >
                  ...
                  <div class="page-title">
                      <div class="container">
                          <h3>  Rejected Product Listings</h3>
                      </div>
                  </div>
  ...
  <tr style="border-top: 1px solid #eee;">
      ...
      @endif
       ...
       <td style="max-width:150px;">
        ...
        @php( $name = "<span style='color: #0f7dc2;'>" .$user->first_name." ".$user->last_name." </span> - ".$seller->name)
          {!! $name !!} 
          @endif
       </td>
  ...
  @else
  <tr>
    <td  colspan="6"> No rejected products listings</td>
