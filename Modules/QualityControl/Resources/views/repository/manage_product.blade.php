                    ...
                    <div class="container" style="padding-top: 10px;">
                      <div class="col-md-5">
                        <h3 style="padding-bottom: 5px;">  
                          Update:  {{$product->name}}, Product  Code: <span style="color: blue;font-weight: bold;">REPOSITORY </span>
                        </h3>
                      </div>
                      ...
                      <div class="col-md-2">
                        ...
                        <span class="pull-right">
                           <form  method="POST"  action="{{url('qc/publish_product')}}">
                              ...
                              <input type="submit" class="btn btn-warning orange-button" value="Accept"/>
                ...
                <div class="container" >
                  <div class="panel panel-white">
                    ...
                    <div class="col-md-12">
                     ...
                     @include('qc::repository.product_form',compact('product'))
                  </div> 
                </div>
