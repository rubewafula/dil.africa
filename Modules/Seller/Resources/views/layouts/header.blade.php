            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                    ...
                    <ul class="list-unstyled" style="text-transform:uppercase; font-size:11px">
                        @if(Auth::user() == null)
                        <li><a href="{{url('/seller/login')}}"><i class="icon fa fa-lock"></i>Login</a></li>
                        @endif
                        @if(Auth::check())
                    ...
                    <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active dropdown yamm-fw">
                                    <a href="{{url('seller/my-promotions')}}">My Promotions</a>
                                </li>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                                                        ...
                                                        <ul class="links">
                                                            ...
                                                            <li style="padding: 10px 0px;"><a href="{{url('seller/sales_report')}}">Sales Report</a></li>
                                                            <li style="padding: 10px 0px;"><a href="{{url('seller/sales_report')}}">Account Statements</a></li>
                                ...
                                <li class="dropdown yamm mega-menu">
                                    <a href="{{url('shop/')}}" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Settings</a>
                                    <ul class="dropdown-menu container">
                                        <li>
                                            <div class="yamm-content ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                                                        ...
                                                        <ul class="links">
                                                            ...
                                                            <li style="padding: 10px 0px;"><a href="{{url('seller/manage_profile')}}">Manage Profile</a></li>
                                                            <li style="padding: 10px 0px;"><a href="{{url('seller/users')}}">Manage Users</a></li>
