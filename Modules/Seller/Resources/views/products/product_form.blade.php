...
{{Form::textarea('product_description',$product->product_description,['class'=>'form-control textarea',
                   ...
                   <div class="row">
                     ...
                     <div class="col-md-6">
                       <div  class="form-group">
                              ...
                              @if(isset($type))
                              {{Form::select('category_id',$categories ,$category_id, ['class'=>'form-control required', 'id' => 'category_id'])}} 
                              @else
                              {{Form::select('category_id',$categories ,$product->category_id, ['class'=>'form-control required', 'id' => 'category_id'])}}                                                                        
                              @endif
                        </div>
                    </div>
                     <div class="col-md-6">
     ...
     {{Form::text('main_material',$product->main_material,['class'=>'form-control'])}}
            ...
            <div role="tabpanel" class="tab-pane" id="tab2">
              ...
              <div  class="row">
                <div  class="col-md-12">
                  <form  method="POST"  action="{{url('seller/update_features')}}">
                    {{csrf_field()}}
                    <input  type="hidden" name="product_id"  value="{{$product->id}}">
                  <table  class="table">
...
<div class="row">
  <div class="col-md-6">
     <a href="{{url('seller/remove_pricing/'.$price->id)}}" onclick="return  confirm('Are  you sure you want to remove this price record?')" class="btn btn-danger btn-sm"> Delete</a>
</div>
<div class="col-md-6">
...
<div role="tabpanel" class="tab-pane" id="tab4">
  ...
  <div  class="col-md-2">
    ...
    @else
    <a href="{{url('seller/image/make_default/'.$image->id)}}">
      <button class="btn orange-button" style="margin-top: 10px;">Make Default</button>
    </a>
    @endif
  <span class=""> 
    <a  href="{{url('seller/remove_image/'.$image->id)}}" class="btn-danger" onclick="return confirm('Are you  sure you want to delete this image?')">  <span class="glyphicon glyphicon-trash" aria-hidden="true" title="Delete Image"></span></a>
  </span>
