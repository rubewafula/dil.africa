...
@section('content')
                ...
                <div id="main-wrapper" class="container">
                    <div class="row">
                        ...
                        <form method="GET" action="{{ url('/backend/sub_categories') }}" accept-charset="UTF-8" class="form-inline " role="search">
  ...
  <div class="form-group mx-sm-12 mb-12">
    ...
    <button class="btn btn-secondary" type="submit">
                                     ...
                                     <div  class="col-md-4 col-sm-12">
                                                     <span  class="pull-right"> <a href="{{ url('/backend/sub_categories/create') }}" class="btn btn-success btn-sm" title="Add New ">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ url('/backend/sub_categories' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                                ...
                                @endforeach
                                                                   ...
                                                                   <div class="pagination-wrapper"> {!! $sub_categories->appends(['search' => Request::get('search')])->render() !!} </div>
