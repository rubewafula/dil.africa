    ...
    <div class="page-title">
        <div class="container">
            <h3> Edit  Campaign #{{ $promotion_banner->id }} </h3>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-white">
                    ...
                    <div class="panel-body">
                                                ...
                                                <form method="POST" action="{{ url('/backend/campaign/' . $promotion_banner->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                {{ method_field('PATCH') }}
                {{ csrf_field() }}

                @include ('backend::promotion_banners.form', ['submitButtonText' => 'Update'])
