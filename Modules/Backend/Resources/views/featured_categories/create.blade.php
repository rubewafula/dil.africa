  ...
  $(document).ready(function(){
    ...
    <div id="main-wrapper" class="container">
        <div class="row">
            ...
            <form method="POST" action="{{ url('/backend/featured-categories') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
                <?php $featured_category = new \App\Featured_category; ?>

                @include ('backend::featured_categories.form')
