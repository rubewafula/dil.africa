        ...
        <div class="col-md-12">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                      <a href="{{ url('/backend/sellers/manage/' . $item->id) }}" title="Manage Seller"><button class="btn btn-success btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Manage</button></a>
