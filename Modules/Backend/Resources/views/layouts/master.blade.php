...
<link href="{{url('assets/css/bootstrap-responsive.min.css')}}" rel="stylesheet">
<link href="http://fonts.googleapis.com/css?family=Open+Sans:400italic,600italic,400,600"
        rel="stylesheet">
<link href="{{url('assets/css/font-awesome.css')}}" rel="stylesheet">
<link href="{{url('assets/css/style.css')}}" rel="stylesheet">
<link href="{{url('assets/css/pages/dashboard.css')}}" rel="stylesheet">
...
<script src="{{url('assets/js/jquery-1.7.2.min.js')}}"></script> 
<script src="{{url('assets/js/excanvas.min.js')}}"></script> 
<script src="{{url('assets/js/chart.min.js')}}" type="text/javascript"></script> 
<script src="{{url('assets/js/bootstrap.js')}}"></script>
<script language="javascript" type="text/javascript" src="{{url('assets/js/full-calendar/fullcalendar.min.js')}}"></script>
