        ...
        $('#level_2_category').select2();
                ...
                <div id="main-wrapper" class="container">
                    <div class="row">
                        ...
                        <form method="POST" action="{{ url('/backend/feature_types') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('backend::feature_types.form')
