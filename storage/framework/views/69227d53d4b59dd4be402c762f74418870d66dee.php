...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?php echo e($product->keywords); ?>,Buy, Products, eCommerce">
        <?php else: ?>
        ...
        <link rel="stylesheet" href="<?php echo e(url('assets/css/jquery-editable-select.min.css')); ?>">
    ...
    <body class="cnt-home">
        ...
        <?php echo $__env->make('customer::layouts.checkout_header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <script src="<?php echo e(url('assets/js/processor.js')); ?>"></script>
