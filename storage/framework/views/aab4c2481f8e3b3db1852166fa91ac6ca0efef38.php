...
<div class="body-content outer-top-xs" id="top-banner-and-menu">
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                ...
                <div class="sidebar-widget outer-bottom-small hidden-md hidden-lg">
                 ...
                 <section class="section wow fadeInUp new-arriavls hidden-xs hidden-sm">
                    ...
                    <?php echo $__env->make('customer::home.electronics', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </section> 
    ...
    padding: 8px;">
            ...
            <div class="col-sm-1" style="padding:7px;">
                <img src="<?php echo e(url('assets/images/clock.png')); ?>"/>
            </div>
            <div class="col-sm-4" style="font-weight: bold;
    font-size: 24px;
    padding: 30px;">
            ...
            <div class="col-sm-1" style="padding:3px;">
                <img src="<?php echo e(url('assets/images/happy-black-woman.png')); ?>"/>
            </div>
            <div class="col-sm-1" style="padding:3px;">
                <a href="<?php echo e(url('/shop/flash-sale')); ?>">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 sidebar hidden-xs">
            <div class="sidebar-widget  wow fadeInUp outer-top-vs " style="padding-bottom: 36px;">
                ...
                <?php echo $__env->make('customer::home.sidebar.fashion', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
            ...
            <section class="section wow fadeInUp new-arriavls hidden-xs hidden-sm" style="margin-top: 20px;">
                <?php echo $__env->make('customer::home.fashion', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </section>
    ...
    padding: 28px 10px;">
            ...
            <div class="col-sm-1" style="padding:7px;">
                <img src="<?php echo e(url('assets/images/carousel/hair.png')); ?>"/>
            </div>
            <div class="col-sm-4" style="font-weight: bold;
    font-size: 26px;
    padding: 30px;color: #FA0">
            ...
            <div class="col-sm-2" style="padding:10px 0px;">
                <img src="<?php echo e(url('assets/images/carousel/she_lipgloss.png')); ?>" width="50px" />
                <img src="<?php echo e(url('assets/images/carousel/shaver_2.png')); ?>" width="50px" />
            </div>
            <div class="col-sm-1" style="padding:3px;">
                <a href="<?php echo e(url('/shop/category/fragrances')); ?>" style="color:#FFF;">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 sidebar hidden-xs">
            <div class="sidebar-widget  wow fadeInUp outer-top-vs " style="padding-bottom: 36px;">
                ...
                <?php echo $__env->make('customer::home.sidebar.hair_beauty', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
            ...
            <section class="section wow fadeInUp new-arriavls hidden-xs hidden-sm" style="margin-top: 20px;">
                <?php echo $__env->make('customer::home.hair_beauty', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </section>
            <div class="section new-arriavls hidden-md hidden-lg" style="margin-top: 20px;">
                <?php echo $__env->make('customer::home.hair_beauty', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        ...
        <div class="header-top-inner">
            <div class="cnt-account">
                <ul class="list-unstyled" style="text-transform:uppercase; font-size:11px">
                    <li><a href="<?php echo e(url('/seller/register')); ?>"><i class="icon fa fa-user"></i>Sell</a></li>
