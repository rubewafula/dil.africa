                            ...
                            <div class="col-sm-10" style="padding: 0px;">
                                <select id="item_size" name="item_size">
                                    ...
                                    <?php if($price->size != null && $price->color == null): ?>
                                        ...
                                        <option value="<?php echo e($price->id); ?>" <?php if($price->id == $product_price->id): ?> selected <?php endif; ?>><?php echo e($price->size); ?></option>
                                    <?php elseif($price->size == null && $price->color != null): ?>
                                        $combination = $price->color; 
                                        <option value="<?php echo e($price->id); ?>" <?php if($price->id == $product_price->id): ?> selected <?php endif; ?>><?php echo e($price->color); ?></option>
                                    <?php elseif($price->size != null && $price->color != null): ?>
                                        $combination = $price->size."/".$price->color; 
                                        <option value="<?php echo e($price->id); ?>" <?php if($price->id == $product_price->id): ?> selected <?php endif; ?>><?php echo e($price->size); ?> / <?php echo e($price->color); ?></option>
                                    <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
