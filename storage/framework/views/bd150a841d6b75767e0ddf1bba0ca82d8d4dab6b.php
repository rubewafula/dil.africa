  ...
  <div class="container">
      <div class="row">
          <div class="col-md-12">
            ...
            <form method="GET" action="<?php echo e(url('/logistics/vehicles')); ?>" accept-charset="UTF-8" class="form-inline " role="search">
              ...
              <span  class="pull-right"> 
                <a href="<?php echo e(url('/logistics/vehicles/create')); ?>" class="btn btn-success btn-sm" title="Add New ">
              <i class="fa fa-plus" aria-hidden="true"></i> Add New
                      ...
                      <tr>
                          ...
                          <td><?php echo e($item->owner_contacts); ?></td>
                          <td><?php echo e($item->owner_address); ?></td>
                          <td><?php echo e(($item->active == 1)?"Active":"Inactive"); ?></td>
                          <td>
                              
                              <a href="<?php echo e(url('/logistics/vehicles/' . $item->id . '/edit')); ?>" title="Edit Vehicle"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

                              <form method="POST" action="<?php echo e(url('/logistics/vehicles/'. $item->id)); ?>" accept-charset="UTF-8" style="display:inline">
      ...
      <div class="pagination-wrapper"> <?php echo $vehicles->appends(['search' => Request::get('search')])->render(); ?> </div>
