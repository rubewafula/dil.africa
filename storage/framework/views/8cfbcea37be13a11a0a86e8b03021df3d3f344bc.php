        ...
        <div class="products">
            ...
            <div class="product">		
                <div class="product-image">
                    <div class="image">
                        <a href="<?php echo e(url('shop/product/detail/'.$arrival->product->slug)); ?>">
                            <div class="featured-img">
                                <span class="helper"></span>
                                <img  class="img-featured" src="<?php echo e(url('/assets/images/products/'.$arrival->product->getDefaultImage()->image_url)); ?>" alt="">
                            </div>
                        </a>
                    </div><!-- /.image -->			
                ...
                <div class="product-info text-left">
                        ...
                        <h3 class="name"><a href="<?php echo e(url('shop/product/detail/'.$arrival->product->slug)); ?>"><?php echo e($arrival->product->name); ?></a></h3>
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>

                        <?php ($product_price = $arrival->product->getActivePrice()); ?>
       
                        <?php if(count($product_price) == 1 || !$arrival->product->hasDifferentPrices()): ?>
                        ...
                        <div class="product-price"> 
                            ...
                            Ksh <?php echo e(number_format($offer_price + $arrival->product->getShippingCost())); ?>

                            <?php ($sale_price = $offer_price); ?>
                            </span>
                            <span class="price-before-discount">
                                KSh <?php echo e(number_format($standard_price + $arrival->product->getShippingCost())); ?>
                        ...
                        <?php elseif(count($product_price) > 1 && $arrival->product->hasDifferentPrices()): ?>
                        ...
                        <div class="product-price"> 
                            ...
                            <span class="price">
                                ...
                                KSh <?php echo e(number_format($min_price + $arrival->product->getShippingCost())); ?> - KSh <?php echo e(number_format($max_price + $arrival->product->getShippingCost())); ?>
                            ...
                            <ul class="list-unstyled">
                                <li class="add-cart-button btn-group">
                                    <form method="POST" action="<?php echo e(url('shop/add_to_cart')); ?>">
                                        <input type="hidden" value="<?php echo e($arrival->product->getActivePrice()->first()->id); ?>" name="product_ref" />
                                        <input type="hidden" value="1" name="quantity" />
                                        <button data-toggle="tooltip" class="btn btn-primary icon addtocart" type="submit" product_ref="<?php echo e($arrival->product->getActivePrice()->first()->id); ?>" title="Buy Now">
                                ...
                                <li class="lnk wishlist">
                                    <a class="add-to-cart" href="<?php echo e(url('shop/add_to_wishlist/'.$arrival->product->id.'/'.$arrival->product->getActivePrice()->first()->id)); ?>" title="Add to Wishlist">
