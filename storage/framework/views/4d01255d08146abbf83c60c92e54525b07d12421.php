            ...
            <div id="review" class="tab-pane">
                <div class="product-tab">
                    ...
                    <div class="product-reviews">
                        ...
                        <div class="reviews">
                            <div class="review">
                                <div class="review-title"><span class="summary"><?php echo e($review->rating); ?> Stars</span><span class="date">
                                        <i class="fa fa-calendar"></i><span><?php echo e($days); ?> days ago</span></span></div>
                    ...
                    <form role="form" method="POST" action="<?php echo e(url('/shop/review')); ?>" class="cnt-form">
