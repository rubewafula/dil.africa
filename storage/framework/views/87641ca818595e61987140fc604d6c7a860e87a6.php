                ...
                <td class="header" style="width: 65%;">
                    <div>
                        <a href="<?php echo e(url('/shop')); ?>">
                            <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="DIL.AFRICA"/>
                        </a>
                    </div>
                    <div>
                        <a href="<?php echo e($url); ?>">
                           <span style="font-size: 16px;color: #FFF;"> <?php echo e($slot); ?>, </span> <span style="font-style: italic;font-size: 12px;color:#FFF;font-weight: normal;">The Ultimate Customer Experience! </span>
                        </a>
                    </div>
                </td>
