<!DOCTYPE html>
   <html>
    <head>
        ...
        <!-- Title -->
        <title> DIL.AFRICA | <?php if(isset($title)): ?> <?php echo e($title); ?> <?php else: ?> QC  Dashboard  <?php endif; ?> </title>
    ...
    <body class="compact-menu page-horizontal-bar">
        ...
        <main class="content-wrap">
            ...
            <?php echo $__env->make('qc::layouts.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
         
            <div class="page-inner container">
                     
                <?php echo $__env->make('qc::layouts.notifications', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                      
                <?php echo $__env->yieldContent('content'); ?>

                <?php echo $__env->make('qc::layouts.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
