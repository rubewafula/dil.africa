            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                    ...
                    <ul class="list-unstyled" style="text-transform:uppercase; font-size:11px">
                        ...
                        <li><a href="<?php echo e(url('/qc/login')); ?>"><i class="icon fa fa-lock"></i>Login</a></li>
                        <?php endif; ?>
                        <?php if(Auth::check()): ?>
                        ...
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                <li class="active dropdown yamm-fw">
                                    <a href="<?php echo e(url('qc')); ?>">Dashboard</a>
                                </li>
                                <li class="active dropdown yamm-fw">
                                    <a href="<?php echo e(url('qc/products')); ?>">Products</a>
                                </li>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                                                        ...
                                                        <ul class="links">
                                                            ...
                                                            <li style="padding: 10px 0px;"><a href="<?php echo e(url('qc/quality_passed_report')); ?>">Quality Passed Report</a></li>
                                                            <li style="padding: 10px 0px;"><a href="<?php echo e(url('qc/quality_failed_report')); ?>">Quality Failed Report</a></li>
                                ...
                                <li class="active dropdown yamm-fw">
                                    <a href="<?php echo e(url('qc/report')); ?>">QC Report</a>
                                </li>

                                <li class="active dropdown yamm-fw">
                                    <a href="<?php echo e(url('qc/seller-profiles')); ?>">Seller Profiles</a>
                                </li>
