        ...
        <div class="products">
            ...
            <div class="product">		
                ...
                <div class="product-info text-left">
                    <h3 class="name"><a href="<?php echo e(url('shop/product/detail/'.$product->product_id)); ?>"><?php echo e($product->product->name); ?></a></h3>
                    ...
                    <div class="product-price">	
                        ...
                        <span class="price-before-discount">KSh <?php echo e($productPrice->standard_price); ?></span>
                        <input type="hidden" value="<?php echo e($product->id); ?>" id="product_featured_ref" />
                    </div><!-- /.product-price -->
