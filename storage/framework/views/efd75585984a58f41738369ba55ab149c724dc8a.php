<div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs hidden-xs hidden-sm">
        ...
        <div class="products">
            ...
            <div class="product">		
                <div class="product-image">
                    <div class="image">
                        <a href="<?php echo e(url('shop/product/detail/'.$product->product->slug)); ?>">
                            <img  class="img-featured" src="<?php echo e(url('assets/images/products/'.$product->product->getDefaultImage()->image_url)); ?>" alt=""></a>
                        </div><!-- /.image -->			
                ...
                <div class="product-info text-left">
                        <h3 class="name"><a href="<?php echo e(url('shop/product/detail/'.$product->product->slug)); ?>"><?php echo e(ucwords($product->product->name)); ?></a></h3>
                        ...
                        <div class="product-price"> 
                            ...
                            <span class="price">
                                ...
                                KSh <?php echo e($min_price); ?> - KSh <?php echo e($max_price); ?>
                            ...
                            <ul class="list-unstyled">
                                <li class="add-cart-button btn-group">
                                    <form method="POST" action="<?php echo e(url('shop/add_to_cart')); ?>">
                                        ...
                                        <button data-toggle="tooltip" class="btn btn-primary icon addtocart" type="submit" product_ref="<?php echo e($product_price->first()->id); ?>" title="Add Cart">
                                ...
                                <li class="lnk wishlist">
                                    <a class="add-to-cart" href="<?php echo e(url('shop/add_to_wishlist/'.$product->product->id.'/'.$product_price->first()->id)); ?>" title="Wishlist">
