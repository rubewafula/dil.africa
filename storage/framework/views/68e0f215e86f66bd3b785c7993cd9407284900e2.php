                        ...
                        <div class="panel panel-default checkout-step-01">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse in">
                                ...
                                <div class="panel-body">
                                    <div class="row">		
                                        <form class="address-form" role="form" method="POST" action="<?php echo e(url('shop/checkout/register-guest')); ?>">
                                            <div class="col-md-6 col-sm-12 already-registered-login">                                           
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control unicase-form-control text-input"
                                                           id="first_name" name="first_name" value="<?php echo e(isset($user)?$user->first_name:""); ?>" required />
                                                </div>

                                                <div class="form-group">
                                                    <label class="info-title" for="email">Email Address <span>*</span></label>
                                                    <input type="email" class="form-control unicase-form-control text-input"
                                                           id="email" name="email" value="<?php echo e(isset($user)?$user->email:""); ?>" required />
                                                </div>
                                            ...
                                            <div class="col-md-6 col-sm-12 already-registered-login">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control unicase-form-control text-input"
                                                           id="last_name" name="last_name" value="<?php echo e(isset($user)?$user->last_name:""); ?>" required />
                                                </div>

                                                <div class="form-group">
                                                    <label class="info-title" for="name">Phone <span>*</span></label>
                                                    <input type="text" class="form-control unicase-form-control text-input"
                                                           id="phone" name="phone" value="<?php echo e(isset($user)?$user->phone:""); ?>" required />
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12 already-registered-login">
