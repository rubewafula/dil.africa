<?php $__env->startSection('content'); ?>
        <div class="body-content">
            ...
            <h3 style="padding-bottom: 20px;" class="blue-text"> DIL.AFRICA Administration</h3>
                                    <div class="row">
                    ...
                    <div class="col-md-5">
                            <img src="<?php echo e(url('assets/images/admin_team.png')); ?>" width="400px" style="padding: 10px;" />
                        </div>
                    </div><!-- Row -->
                </div><!-- Main Wrapper -->
