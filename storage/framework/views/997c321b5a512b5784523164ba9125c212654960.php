                ...
                <div class="col-xs-9 col-sm-9 col-md-3">
                    ...
                    <div class="logo">
                        <a href="<?php echo e(url('/')); ?>">
                            ...
                            <img class="hidden-xs hidden-sm" src="<?php echo e(url('assets/images/logo.png')); ?>" alt="">

                            <img class="hidden-md hidden-lg" style="width: 117px;margin-top: 8px" src="<?php echo e(url('assets/images/logo.png')); ?>" alt="">
                            ...
                            <div class="items-cart-inner" style="margin: 0px auto;">
                                ...
                                <div class="total-price-basket">
                                    ...
                                    <span class="total-price">
                                        ...
                                        <span class="value"><?php echo e(number_format($total_price)); ?></span>
                                        <?php endif; ?>
                                    </span>
                                </div>
                                <?php else: ?>
...
<div class="container">
    ...
    <div class="col-sm-12 free-shipping">
        <img src="<?php echo e(url('assets/images/truck_small.png')); ?>" style="width: 70px;">
        ...
        <img src="<?php echo e(url('assets/images/womsn.png')); ?>" style="width: 70px;">
    </div>
</div>