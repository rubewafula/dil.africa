...
<div  class="container">
           <div class="page-breadcrumb " >
                ...
                <div class="page-title">
                    <div class="container">
                        <h2> Partially Returned Orders</h2>
                    </div>
                </div>
  ...
  <tbody>
  	...
  	<tr>
        ...
        <td> 
           <a style="margin-bottom: 10px;" href="<?php echo e(url('logistics/order-details/'.$referrer.'/'.$order->id)); ?>" class="btn btn-success btn-sm" >  View Order Details</a>
        </td>
  	</tr>
