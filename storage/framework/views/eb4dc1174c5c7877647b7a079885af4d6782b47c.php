  ...
  <?php $__env->startSection('content'); ?>
                  ...
                  <div id="main-wrapper" class="container">
                      <div class="row">
                          ...
                          <form method="GET" action="<?php echo e(url('/backend/riders')); ?>" accept-charset="UTF-8" class="form-inline " role="search">
                              ...
                              <span  class="pull-right"> <a href="<?php echo e(url('/backend/riders/create')); ?>" class="btn btn-success btn-sm" title="Add New ">
                              <i class="fa fa-plus" aria-hidden="true"></i> Add New
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              ...
                                              <a href="<?php echo e(url('/backend/riders/' . $item->id . '/edit')); ?>" title="Edit Rider"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

                                              <form method="GET" action="<?php echo e(url('/backend/riders' . '/purge/' . $item->id)); ?>" accept-charset="UTF-8" style="display:inline">
