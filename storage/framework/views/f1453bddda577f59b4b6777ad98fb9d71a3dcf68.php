    ...
    <body class="page-header-fixed compact-menu page-horizontal-bar">
        ...
        <main class="page-content content-wrap">
            <div class="navbar" style="background-color:">
                    ...
                    <div class="topmenu-outer">
                        <div class="top-menu">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                               ...
                               <?php echo $__env->make('logistics::layouts.messages', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                               <?php echo $__env->make('logistics::layouts.alerts', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                               <?php echo $__env->make('logistics::layouts.profile_overview', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <?php echo $__env->make('logistics::layouts.menu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<div class="mess alert <?php echo e(Session::get('alert-class', 'alert-success')); ?> alert-dismissable" style="margin-top: 15px;"> 
