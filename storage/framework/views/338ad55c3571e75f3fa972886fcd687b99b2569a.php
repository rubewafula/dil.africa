  ...
  <tbody>
  	...
  	<tr>
       ...
       <td> 
           ...
           <a style="margin-bottom: 10px;" href="<?php echo e(url('logistics/quality_passed/'.$order->id)); ?>" onclick=" return  confirm('You  are  about to  receive Order.Confirm')"  class="btn btn-success btn-sm" >  Quality  Passed</a> &nbsp;&nbsp;&nbsp;&nbsp;

           <!--  <a  href="<?php echo e(url('logistics/reject_order/'.$order->id)); ?>"  class="btn  btn-danger  btn-sm"> Reject  Order </a> -->
           <button style="width: 110px;" type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#reject<?php echo e($order->id); ?>">Quality  Failed</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="<?php echo e(url('logistics/quality_failed')); ?>">
          ...
          <div  class="form-group">
            ...
            <select  name="quality_issue_id"  class="form-control">
              <?php $__currentLoopData = $quality_issues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $issue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option  value="<?php echo e($issue->id); ?>"><?php echo e($issue->name); ?></option>
