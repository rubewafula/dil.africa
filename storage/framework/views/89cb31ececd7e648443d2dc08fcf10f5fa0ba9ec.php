      ...
      $.ajax({
          type: "POST",
          url: "<?php echo e(url('qc/update_product_features')); ?>",
          data: datastring,
         // dataType: "json",
  ...
  <ul class="nav nav-tabs" role="tablist" id="tabMenu">
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane active "" id="tab1">
               <form  method="POST"  action="<?php echo e(url('qc/products/save')); ?>">
                <?php echo e(csrf_field()); ?>


                <input  type="hidden" name="seller_id" value="<?php echo e($product->seller_id); ?>">
...
<?php echo e(Form::textarea('product_description',$product->product_description,['class'=>'form-control textarea',
             ...
             <?php echo $errors->first('product_description', '<p class="help-block">:message</p>'); ?>
                   ...
                   <div class="row">
                     ...
                     <div class="col-md-6">
                       <div  class="form-group">
                            <label> Model</label>
                             <?php echo e(Form::text('model',$product->model,['class'=>'form-control','id'=>'model'])); ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                       <div  class="form-group">
                              ...
                              <?php echo e(Form::select('tax_class',$tax_classes,$product->tax_class,['class'=>'form-control required'])); ?>
     ...
     'id'=>'brands'])); ?>
            ...
            <div role="tabpanel" class="tab-pane" id="tab2">
              ...
              <div  class="row">
                <div  class="col-md-12">
<form  method="POST" id="update_featuress"  action="<?php echo e(url('qc/update_product_features')); ?>">  
                    <?php echo e(csrf_field()); ?>
...
<?php echo e(Form::text('value',null,['class'=>'form-control','id'=>'description'])); ?>
                  ...
                  <table  class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td> <a  href="<?php echo e(url('qc/remove_product_feature/'.$feature->id)); ?>" class="btn btn-danger" onclick=" return  confirm('Are  you  sure?')">  Delete</a></td>
                      </tr>
              ...
              <form  method="POST"  action="<?php echo e(url('qc/update_product_details')); ?>">
...
<?php echo e(Form::select('brand_id',$brands,$product->brand_id,['class'=>'form-control'])); ?>
     ...
     <?php echo e(Form::text('main_material',$product->main_material,['class'=>'form-control'])); ?>
            ...
            <div role="tabpanel" class="tab-pane" id="tab3">                                                    
                ...
                <div  id="new_product">
               <form method="POST"  action="<?php echo e(url('qc/product/add_price')); ?>">
                 ...
                 <?php endif; ?>     
                    ...
                    <div class="col-md-6">
                        <div  class="form-group">
                            ...
                            <?php echo e(Form::number('quantity',null,['class'=>'form-control', 'step' => 1])); ?>
                    ...
                    <div class="col-md-6">
                        <div  class="form-group">
                            <label> Price </label>
                            <?php echo e(Form::number('standard_price',null,['class'=>'form-control', 'step' => 0.1])); ?>
 ...
 <table class="table" style="border:1px solid #eee;">
  ...
  <tbody>
      ...
      <tr style="border-top:1px solid #eee;">
         ...
         <a href="<?php echo e(url('qc/remove_pricing/'.$price->id)); ?>" onclick="return  confirm('Are  you sure you want to remove this price record?')" class="btn btn-warning"> Delete</a>
         <a href="<?php echo e(url('qc/promote-product/'.$price->id)); ?>" class="btn btn-success blue-button">Promote</a>
        ...
        <form method="POST"  action="<?php echo e(url('qc/product/update_price')); ?>">
...
<div role="tabpanel" class="tab-pane" id="tab4">
  ...
  <div  class="col-md-2">
    ...
    <?php else: ?>
    <a href="<?php echo e(url('qc/image/make_default/'.$image->id)); ?>">
      <button class="btn orange-button" style="margin-top: 10px;">Make Default</button>
    </a>
    <?php endif; ?>
  <span class=""> 
    <a  href="<?php echo e(url('qc/remove_image/'.$image->id)); ?>" class="btn-danger" onclick="return confirm('Are you  sure you want to delete this image?')">  <span class="glyphicon glyphicon-trash" aria-hidden="true" title="Delete Image"></span></a>
  </span>
  ...
  <div style="margin-top: 20px;">
    ...
    <form  method="POST"  action="<?php echo e(url('qc/upload_images')); ?>" enctype="multipart/form-data">
      <input  type="hidden"  name="product_id" value="<?php echo e($product->id); ?>">
       <input  type="hidden"  name="product_price_id" value="<?php echo e($price->id); ?>">
      <?php echo e(csrf_field()); ?>
