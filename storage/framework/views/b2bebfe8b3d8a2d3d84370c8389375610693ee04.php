  ...
  <tbody>
  	...
  	<tr>
        ...
        <td> 
          ...
          <a href="<?php echo e(url('/logistics/trips/orders/entire-order-delivered/'.$order->id)); ?>" class="btn btn-success btn-sm" title="Mark Order as Delivered" style="margin-bottom: 10px;">
      ...
      <a style="margin-bottom: 10px;width: 176px;" href="<?php echo e(url('logistics/order-details/'.$referrer.'/'.$order->id)); ?>" class="btn btn-success btn-sm orange-bg">  View Order Details</a>
    </td>
  	</tr>
