...
<?php $__env->startSection('content'); ?>
                ...
                <div id="main-wrapper" class="container">
                    <div class="row">
                        ...
                        <form method="POST" action="<?php echo e(url('/logistics/trips')); ?>" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>

                            <?php $trip =  new  App\Trip; ?>

                            <?php echo $__env->make('logistics::trips.form',compact('trip'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
