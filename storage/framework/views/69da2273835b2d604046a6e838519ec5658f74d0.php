<?php $__env->startSection('content'); ?>
                ...
                <div id="main-wrapper" class="container">
                    <div class="row">
                        ...
                        <form method="GET" action="<?php echo e(url('/backend/countries')); ?>" accept-charset="UTF-8" class="form-inline " role="search">
  ...
  <div class="form-group mx-sm-12 mb-12">
    ...
    <button class="btn btn-secondary" type="submit">
                                     ...
                                     <div  class="col-md-4 col-sm-12">
                                                     <span  class="pull-right"> <a href="<?php echo e(url('/backend/countries/create')); ?>" class="btn btn-success btn-sm" title="Add New ">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                                    ...
                                    <table id="crud" class="display table" style="width: 100%; cellspacing: 0;">
                                        <thead style="background: #ffa200;color:#fff;opacity: 0.7">
                                            <tr>
                                               <tr>
                                        <th>#</th><th>Name</th><th>Country Iso</th><th>Actions</th>
                                    </tr>
                                            </tr>
                                        </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($item->name); ?></td><td><?php echo e($item->country_iso); ?></td>
                                        <td>
                                            
                                            <a href="<?php echo e(url('/backend/countries/' . $item->id . '/edit')); ?>" title="Edit Country"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

                                            <form method="POST" action="<?php echo e(url('/backend/countries' . '/' . $item->id)); ?>" accept-charset="UTF-8" style="display:inline">
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                   ...
                                                                   <div class="pagination-wrapper"> <?php echo $countries->appends(['search' => Request::get('search')])->render(); ?> </div>
