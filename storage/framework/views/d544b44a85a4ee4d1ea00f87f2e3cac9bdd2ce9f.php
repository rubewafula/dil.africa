<?php $__env->startSection('content'); ?>
 ...
 <table class="table table-bordered">
  <thead class="thead-dark" style="background-color:#ffa200;color:#fff">
    ...
    <tbody>
     ...
     <tr>
        ...
        <?php if($order->order_detail != null): ?>
     		   <ol>
     		   	<li>
              <u> Product: <?php echo e(str_limit($order->order_detail->product->name, 50,'...')); ?> </u>
                Qty:<?php echo e($order->order_detail->quantity); ?> <br/>
              <a href="">By <?php echo e($order->order_detail->product->seller->name); ?> </a>
            </li>
     		   </ol>
        <?php endif; ?>
      ...
      <td>
         ...
         <?php echo $order->order->getDeliveryAddress(); ?>
    ...
    <form method="POST" action="<?php echo e(url('logistics/direct_shipment')); ?>">
